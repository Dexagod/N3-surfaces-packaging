...
do
  ...
  node software/move-to-surface.js $f -s onDataSurface > ./data_processed/$(basename $f)
done
...
node software/move-to-surface.js intermediate/run1.n3 -s onDataSurface > intermediate/run1_processed.n3
